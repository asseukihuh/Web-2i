...
var divajmin = document.getElementById('ajoutermin');
...
function afficherInfo(){
    //divajmin.innerHTML+="<div id='importationdiv'></div>"
    //infodiv.innerHTML="";
    infodiv.innerHTML+="<div><label for='Auteur'>Auteur :</label><input name='Auteur' id='at' type='text'></div>";
    infodiv.innerHTML+="<div><label for='Date'>Date :</label><input name='Date' id='dt' type='text'></div>";
    infodiv.innerHTML+="<div><label for='Durée'>Durée (heures) :</label><input name='Durée' id='dr'type='text'></div>";
